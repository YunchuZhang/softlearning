...
class FetchPush(gym.Env):
	def __init__(self):
		self.cfg = YamlConfig(
			'/home/katadh/Documents/Research/VMGE/softlearning/softlearning/environments/gym/flex/fetch_push.yaml')
...
class FetchReachMultiRobot:
	def __init__(self):
		# self.cfg = YamlConfig('/home/georgejo/rlkit/examples/her/cfg/fetch_reach.yaml')
		self.cfg = YamlConfig('/home/a/workspace/katerina/rlkit/examples/her/cfg/fetch_reach.yaml')

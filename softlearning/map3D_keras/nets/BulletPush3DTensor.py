...
class BulletPush3DTensor4_cotrain(BulletPushBase):
    ...
    def building_3D_tensor(self):
        ...
        self.unprojected_features = grnn_op.unproject_inputs(inputs2Denc, use_outline=const.USE_OUTLINE,\
    ...
    def pass_2Denc(self, is_summ_feat=False):
        ...
        # one 2Dencoder
        output = grnn_op.get_outputs2Denc(all_frames, is_training=self.is_training, is_not_bn=const.IS_NOT_BN_IN_2D,encoder2D=self.output2DEnc)
        # two 2Ddecoder

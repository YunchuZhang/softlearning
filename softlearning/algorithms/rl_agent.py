...
class RLAgent():
    ...
    def __init__(
        ...
        self._env = get_environment_from_params_custom(variant['environment_params']['training'])
        self._eval_env = get_environment_from_params_custom(variant['environment_params']['evaluation'])

...
class MappingTrainer():
    ...
    def train_epoch(self, epoch, sample_batch=None, batches=100, from_rl=False):
        ...
        for batch_idx in range(batches):
            ...
            _, loss = self._session.run([self.model.opt,self.model.loss_],
                                                feed_dict={self.model.dictVal:tempData})
            # TODO_MIHIR fill the right feed Dict
    ...
    # TODO_MIHIR ADD TESTING CODE FOR 

...
class SawyerPickAndPlaceEnvV2(MultitaskEnv, SawyerXYZEnv):
    ...
    def step(self, action):
        ...
        rgb, depth = self.render(mode='both_arrays')
        plt.imsave('/home/audrey/img_results/rgb/rgb_' + str(self.index) + '.png', rgb)
        plt.imsave('/home/audrey/img_results/depth/depth_' + str(self.index) + '.png', depth)
        self.index += 1
